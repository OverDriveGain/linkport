<template>
  <div class="pt-16">
    ...
    <div class="bg-gradient-to-br from-slate-900 to-slate-950 border-b border-slate-800 py-16 text-center px-4">
      <p class="section-label mb-3">Trust & Safety</p>
      <h1 class="font-display text-4xl font-bold text-white mb-3">Security</h1>
      <p class="text-slate-400 max-w-xl mx-auto">How we protect your data and how to report security vulnerabilities.</p>
    </div>
    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 py-16 space-y-10">
      ...
      <section>
        <h2 class="text-white text-xl font-bold mb-4">Our security practices</h2>
        <div class="space-y-4">
          <div class="flex items-start gap-4">
            <div class="w-8 h-8 rounded-lg bg-[#0A66C2]/15 flex items-center justify-center flex-shrink-0">
              <svg class="w-4 h-4 text-[#378FE9]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="text-white font-semibold mb-1">Infrastructure in Germany</h3>
              <p class="text-slate-400 text-sm leading-relaxed">Our servers are located in Germany (Berlin region), subject to GDPR and German data protection law. [Hosting provider: Hetzner — Placeholder, confirm before launch].</p>
            </div>
          </div>
      ...
      <section>
        ...
        <div class="card border-[#0A66C2]/30 bg-[#0A66C2]/5">
          <h3 class="text-white font-semibold mb-3">Report a security issue</h3>
          <p class="text-slate-400 text-sm mb-4">Please include: a description of the vulnerability, steps to reproduce, affected component, and your contact information.</p>
          <a href="mailto:security@kaxtus.com" class="btn-primary text-sm py-2 px-4 inline-flex">
            security@kaxtus.com
          </a>
          <p class="text-slate-500 text-xs mt-3">PGP key available on request. [Key fingerprint placeholder — TBD]</p>
        </div>
      </section>
