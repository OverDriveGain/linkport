...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="w-7 h-7 rounded-md bg-[#0A66C2] flex items-center justify-center font-display font-bold text-white text-xs"${_scopeId}> A </div><span class="font-display font-bold text-white"${_scopeId}>assembr</span>`);
      } else {
        return [
          createVNode("div", { class: "w-7 h-7 rounded-md bg-[#0A66C2] flex items-center justify-center font-display font-bold text-white text-xs" }, " A "),
          createVNode("span", { class: "font-display font-bold text-white" }, "assembr")
        ];
      }
    }),
    _: 1
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const pageSubtitle = computed(() => {
      var _a;
      const map = {
        "/dashboard": "Your platforms at a glance",
...
//# sourceMappingURL=dashboard-8PV_hJVt.mjs.map
