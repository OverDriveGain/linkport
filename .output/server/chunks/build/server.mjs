...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BpFu9noL.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D-HoDVHG.mjs'));
...
export { useSeoMeta as a, useRoute as b, useRouter as c, useNuxtApp as d, entry$1 as default, useRuntimeConfig as e, nuxtLinkDefaults as f, navigateTo as n, resolveRouteObject as r, useHead as u };
